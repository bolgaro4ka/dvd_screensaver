...
def color_logo():
    global counter, logo
    if counter == 0:
        logo = pygame.image.load('img/logo_red.png')
        logo = pygame.transform.scale(logo, (100*percente(), 50*percente()))
        counter+=1
    elif counter == 1:
        logo = pygame.image.load('img/logo_orange.png')
        logo = pygame.transform.scale(logo, (100*percente(), 50*percente()))
        counter+=1
    elif counter == 2:
        logo = pygame.image.load('img/logo_green.png')
        logo = pygame.transform.scale(logo, (100*percente(), 50*percente()))
        counter+=1
    elif counter == 3:
        logo = pygame.image.load('img/logo_blue.png')
        logo = pygame.transform.scale(logo, (100*percente(), 50*percente()))
        counter+=1
    elif counter == 4:
        logo = pygame.image.load('img/logo_fiolet.png')
        logo = pygame.transform.scale(logo, (100*percente(), 50*percente()))
        counter+=1
    elif counter == 5:
        logo = pygame.image.load('img/logo.png')
